...
```mermaid
flowchart LR
  H["/hannah"] -->|301| W["/welcome?via=super-hannah"]
  M["/max"] -->|301| WM["via=super-max"]
  J["/jacob"] -->|301| WJ["via=super-jacob"]
  K["/kevin"] -->|301| WK["via=kevin-unkrich"]
```
...
```mermaid
timeline
    title Hannah Ahn (Superpower-relevant public timeline)
    2018-2020 : Design Lead @ Project Academy (high school era)
    2019-2021 : Product Designer/Manager @ Art of Smart
    Apr-Jun 2020 : PM Intern @ Canva
    Jun 2020 - Mar 2022 : Product Manager @ Canva
    Oct 2020 - present : Co-Founder @ Next Chapter (w/ Max Marchione)
    Jan 2022 - present : Investor (Fractal Capital / related)
    Jun 2022 - Jul 2024 : Founder @ Flair (design agency; YC/VC clients)
    Mar 2023 : Quiet Achievers interview (pre-Superpower)
    Jul 2024 : Founding Designer @ Superpower (LinkedIn)
    ~Apr 2025 : Public unveil as Founding Head of Design; Head of Design title from Apr 2025
    May 2026 : UX Tools / Tommy Geoco podcast on Superpower design
    Aug 2026 : Named Head of Design on superpower.com join blog (Jason Combs)
```
