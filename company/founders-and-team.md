...
```mermaid
flowchart TB
  subgraph founders [Co-founders]
    Max["Max Marchione<br/>CEO"]
    Jacob["Jacob Peters<br/>Executive Chairman"]
    Kevin["Kevin Unkrich<br/>Co-founder / former CTO"]
  end
  subgraph clinical [Clinical spine]
    Anant["Dr Anant Vinjamoori<br/>Chief Longevity Officer"]
    Advisors["Medical advisory<br/>Connealy · Tatem · Lufkin · Malkin · others"]
  end
  Max --> Product["Public voice · product · capital · culture"]
  Jacob --> Brand["Founding trauma · brand · athlete / OrganAge moments"]
  Kevin -.-> Eng["Engineering founding · stepped away after 3+ years"]
  Anant --> Longevity["Longevity / clinical framing"]
  Advisors --> Credibility["Marketing clinical credibility"]
```
