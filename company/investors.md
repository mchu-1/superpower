...
| Co-investors (named on page) | Susa Ventures, Long Journey Ventures, Day One Ventures, Family Fund, Bond Capital, Opal Ventures, Valia Ventures, Visible Ventures, Winklevoss Capital |
...
## Off-site funding stack (label clearly)

| Round | Date | Amount | Notes |
| --- | --- | --- | --- |
| Pre-seed **[off-site]** | May 2024 | **$4M** | Susa lead; Long Journey, Family Fund, angels |
| Series A | Apr 2025 | **$30M** | Matches official page |
| Valuation **[off-site]** | Launch coverage | **>$300M** post | Capital Brief / Sacra / company-attributed |
| Later press **[off-site]** | Forbes AU Apr 2026 | ~**$43M** Series A language / **$432M** valuation | **Conflict** — reconcile before stating a single total |

**Working diligence total from primary launch coverage:** ~**$34M** (pre-seed + Series A). Do not silently merge AU press figures.

## Product definition on Series A page (historical packaging)

Page still frames “a few hundred dollars per year” and “**over 100 biomarkers** across 17 categories” — aligns with older packaging, not current homepage **$349 / 150+ / two draws**. See [product-pricing.md](product-pricing.md).
