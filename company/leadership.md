...
## Founders / executives (official site)
...
- **Jacob:** brink of death; 4 months ICU; lost 3 major organs; ~$2M hospital bill.
- **Max:** ~10 years misdiagnosed; dozen+ doctors; told to medicate for life.
- **Kevin (origin story):** friend dying of brain tumour days before scheduled MRI — **[off-site]** / X-adjacent founding lore; site blog refers to “Kevin.”

Screenshots: [../assets/max-marchione.png](../assets/max-marchione.png), [../assets/jacob-peters.png](../assets/jacob-peters.png), [../assets/kevin-unkrich.png](../assets/kevin-unkrich.png).

## Medical advisory / featured clinicians (marketing)

Repeated across homepage, blood-test, manifesto, etc.:

| Clinician | Where named |
| --- | --- |
| Dr. Leigh Erin Connealy, MD | Homepage / manifesto |
| Dr. Alex J. Tatem, MD | Homepage / manifesto |
| Dr. Robert Lufkin, MD | Homepage / manifesto / Series A advisors |
...
## Other exec / ops names **[off-site]**

Previously visible in LinkedIn / public context (may change — verify live): Claire Tolson (Head of Clinical Operations), Shaun Miller (VP Medical Operations), Sofía Prendoné Pita (Clinical Operations), Manoj Arachige (Head of Product), Hannah Ahn (Head of Design), Tim Denman (VP Enterprise). Not treated as official-site canonical roster.
